...
The Original Code is: dmBatSyn.pas from Compiler IDE
...
Version 0.23: Last Edited 25/11/99
  + Fixed problems with REM comment   - in "REMCommentProc"
  + also makes fTokenID == tkComment when upper and lower REMs are used
Version 0.21: Last Edited (unknown)
  + Initial Release
...
procedure Register;
begin
  RegisterComponents(MWS_HighlightersPage, [TdmBatSyn]);
end;
