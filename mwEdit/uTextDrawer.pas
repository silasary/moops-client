...
type
  ...
  public
    ...
    property ForeColor: TColor read FColor write SetForeColor;
    ...
    property CurrentDC: HDC read FDC;
  end;
...
begin
  if (FBkColor <> Value) or (Value=clNone) then
  begin
    FBkColor := Value;
    if FDC <> 0 then
      ...
      begin
        ...
        Windows.SetBkMode(FDC, Windows.OPAQUE);
      end
      else
        Windows.SetBkMode(FDC, Windows.TRANSPARENT);
  end;
end;
