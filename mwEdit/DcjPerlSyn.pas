...
{---------------------------------------------------------------------------
 Perl Language Syntax Parser v0.61
{---------------------------------------------------------------------------
 Revision History:
...
procedure Register;
begin
  RegisterComponents(MWS_HighlightersPage, [TDcjPerlSyn]);
end;
...
function TDcjPerlSyn.KeyComp(const aKey: String): Boolean;
var
  I: Integer;
  Temp: PChar;
begin
...
begin
  ...
  fPragmaAttri := TmwHighLightAttributes.Create(MWS_AttrPragma);
  ...
  MakeMethodTables;
  fRange := rsUnknown;
  fDefaultFilter := MWS_FilterPerl;
end; { Create }

procedure TDcjPerlSyn.SetLine(NewValue: String; LineNumber:Integer);
begin
...
function TDcjPerlSyn.GetTokenAttribute: TmwHighLightAttributes;
begin
  case fTokenID of
...
function TDcjPerlSyn.GetTokenKind: integer;
begin
  Result := Ord(fTokenId);
end;
...
function TDcjPerlSyn.GetLanguageName: string;
begin
  Result := MWS_LangPerl;                                               
end;
