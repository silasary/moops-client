...
{+--------------------------------------------------------------------------+
 ...
 | Version:     0.24 (for version history see version.rtf)
...
//    rsTag,
  ...
  Private
    ...
    fAndAttri: TmwHighLightAttributes;
    fASPAttri: TmwHighLightAttributes;
    ...
    fUndefKeyAttri: TmwHighLightAttributes;
  ...
  Published
    Property AndAttri: TmwHighLightAttributes Read fAndAttri Write fAndAttri;
    property ASPAttri: TmwHighLightAttributes Read fASPAttri Write fASPAttri;
    ...
    Property UndefKeyAttri: TmwHighLightAttributes Read fUndefKeyAttri
...
{  }
Function ThkHTMLSyn.KeyComp(const aKey: String): Boolean;
Var
  i: Integer;
Begin
  Temp := fToIdent;
...
Begin
  fASPAttri := TmwHighLightAttributes.Create(MWS_AttrASP);
  ...
  fUndefKeyAttri := TmwHighLightAttributes.Create(MWS_AttrUnknownWord);
...
{  }
Procedure ThkHTMLSyn.AmpersandProc;
Begin
  Case fAndCode Of
...
function ThkHTMLSyn.GetTokenAttribute: TmwHighLightAttributes;
begin
  case fTokenID of
...
function ThkHTMLSyn.GetTokenKind: integer;
begin
  Result := Ord(fTokenId);
end;
  ...
  If Assigned(Exporter) Then Begin
    With TmwCustomExport(Exporter) Do begin
      Case GetTokenID Of
        ...
        tkASP:        FormatToken(GetToken, fASPAttri,        True, False);
...
Procedure Register;
Begin
  RegisterComponents(MWS_HighlightersPage, [ThkHTMLSyn]);
End;
