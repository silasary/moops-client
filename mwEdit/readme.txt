...
effort for me.
Michael Hieke has kindly offered to maintain the source.
...
Files in main folder:
  ...
  - dmMLSyn.pas:         Standard ML syntax highlighter TdmMLSyn, work of David Muir
  - dmMLSyn.dcr:         componen icon for TdmMLSyn
  ...
  - izIniSyn.pas:        INI files highlighter TizIniSyn, work of Igor P. Zenkov
  - izIniSyn.dcr:        component icon for TizIniSyn
  ...
  - mwDmlSyn.pas:        GEMBASE highlighter TmwDmlSyn, work of Peter Adam
  - mwDmlSyn.dcr:        component icon for TmwDmlSyn
  - mwEdit State Of Development.rtf: 
                         file with bugs, features under construction, features
                         requested etc.
  - mwEdit.inc:          common DEFINEs
  - mwEditPropertyReg:   common Register for all property editors
  - mwEditReg.pas:       "one unit to bind them" - common Register for all
                         mwEdit components; all components can still be 
...
Other folders:
  ...
  - Sample sources:      sample source files to test highlighters with
